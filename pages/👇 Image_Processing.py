...
if app_mode == 'Negative':
    st.subheader(':blue[Negative]')
    OnNegative()
elif app_mode == 'Logarit':
    st.subheader(':blue[Logarit]')
    OnLogarit()
elif app_mode == 'Power':
    st.subheader(':blue[Power]')
    OnPower()
elif app_mode == 'PiecewiseLinear':
    st.subheader(':blue[PiecewiseLinear]')
    OnPiecewiseLinear()
elif app_mode == 'LocalHist':
    st.subheader(':blue[LocalHist]')
    OnLocalHist()
elif app_mode == 'HistStat':
    st.subheader(':blue[HistStat]')
    OnHistStat()
elif app_mode == 'BoxFilter':
    st.subheader(':blue[BoxFilter]')
    OnBoxFilter()
elif app_mode == 'Threshold':
    st.subheader(':blue[Threshold]')
    OnThreshold()
elif app_mode == 'MedianFillter':
    st.subheader(':blue[MedianFillter]')
    OnMedianFillter()
